...
public class DoubleClickMappingEntity extends LitePalSupport {
    private Integer id;
    ...
    public DoubleClickMappingEntity(Integer x, Integer y, Integer keycode, String keyValue, Boolean combination, Integer eventType, Integer planId, Integer combinationKeyCode) {
        this.x = x;
        this.y = y;
        this.keycode = keycode;
        this.keyValue = keyValue;
    ...
    public DoubleClickMappingEntity() {
    }
}
